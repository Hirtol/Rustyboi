...
impl CPU {
    pub fn execute(&mut self, opcode: u8) {
        ...
        match opcode {
            ...
            0xE7 => self.rst(20),
            0xE8 => self.add_sp(), //TODO: Beware, i8 -> NOT u8
            ...
            0xF7 => self.rst(30),
            0xF8 => self.load_sp(), //TODO: Beware, i8 -> NOT u8
            0xF9 => self.load_16bit(SP, HL),
            0xFA => self.load_8bit(A, InstructionAddress::DirectMem),
            0xFB => self.ei(),
            0xFC => self.unknown(),
            0xFD => self.unknown(),
            0xFE => self.cp(InstructionAddress::DIRECT),
            0xFF => self.rst(38),
